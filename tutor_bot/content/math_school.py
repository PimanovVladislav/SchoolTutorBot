...
MATH_SCHOOL_TOPICS: list[dict] = [
    {
        ...
        "theories": [
            ...
            },
            {
                "kind": "text",
                "body": (
                    "<b>Ещё одно объяснение</b>\n\n"
                    "Представь пиццу. Чтобы сложить куски, они должны быть "
                    "одинакового размера.\n\n"
                    "1/2 — это 3 куска из 6, 1/3 — это 2 куска из 6. "
                    "Вместе 5 кусков из 6, то есть 5/6.\n\n"
                    "Правило коротко: приведи к общему знаменателю, "
                    "сложи числители, знаменатель оставь."
                ),
            },
        ],
        "problems": [
            {
                ...
                "hints": [
                    "Приведи к знаменателю 4: 1/2 = 2/4.",
                    "После приведения получится 1/4 + 2/4. Сложи числители.",
                ],
                "solution": (
                    "НОК(4, 2) = 4.\n"
                    "1/2 = 2/4.\n"
                ...
                "solutions": [
                    "НОК(4, 2) = 4.\n1/2 = 2/4.\n1/4 + 2/4 = 3/4.",
                    "Другой ход: 1/4 + 1/2 = 1/4 + 2/4 = 3/4. Сокращать нечего.",
                ],
                "sort_order": 1,
            },
            {
